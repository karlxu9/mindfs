  ...
  const modal = confirmOpen && typeof document !== "undefined" ? createPortal(
    ...
    >
      ...
      >
        ...
        {resetOutcome === "noCredit" ? <div style={{ marginTop: "14px", padding: "9px 11px", borderRadius: "9px", background: "rgba(220, 38, 38, 0.09)", color: "var(--danger-color)", fontSize: "12px" }}>{t("codexLimit.noCredit")}</div> : null}
        {error ? <div style={{ marginTop: "14px", padding: "9px 11px", borderRadius: "9px", background: "rgba(220, 38, 38, 0.09)", color: "var(--danger-color)", fontSize: "12px", overflowWrap: "anywhere" }}>{error}</div> : null}
